<?php
class ControllerSolutionsSolution extends Controller {
	private $error = array();
	...
	protected function getList() {
		...
		$order_total = $this->model_solutions_solution->getTotalOrders($filter_data);

		$results = $this->model_solutions_solution->getOrders($filter_data);
	...
	public function getForm() {
		...
		if (!empty($order_info)) {
			...
			$products = $this->model_solutions_solution->getOrderProducts($this->request->get['order_id']);
			...
			foreach ($products as $product) {
				$data['order_products'][] = array(
					...
					'name'       => $product['name'],
					'model'      => $product['model'],
					'option'     => $this->model_solutions_solution->getOrderOptions($this->request->get['order_id'], $product['order_product_id']),
			...
			$data['order_vouchers'] = $this->model_solutions_solution->getOrderVouchers($this->request->get['order_id']);
			...
			$order_totals = $this->model_solutions_solution->getOrderTotals($this->request->get['order_id']);
	...
	public function info() {
		...
		if ($order_info) {
			...
			foreach ($products as $product) {
				...
				$options = $this->model_solutions_solution->getOrderOptions($this->request->get['order_id'], $product['order_product_id']);
			...
			$vouchers = $this->model_solutions_solution->getOrderVouchers($this->request->get['order_id']);
			...
			$totals = $this->model_solutions_solution->getOrderTotals($this->request->get['order_id']);
	...
	public function history() {
		...
		$history_total = $this->model_solutions_solution->getTotalOrderHistories($this->request->get['order_id']);
	...
	public function invoice() {
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info) {
				...
				$products = $this->model_solutions_solution->getOrderProducts($order_id);

				foreach ($products as $product) {
					$option_data = array();

					$options = $this->model_solutions_solution->getOrderOptions($order_id, $product['order_product_id']);
				...
				$vouchers = $this->model_solutions_solution->getOrderVouchers($order_id);
				...
				$totals = $this->model_solutions_solution->getOrderTotals($order_id);
